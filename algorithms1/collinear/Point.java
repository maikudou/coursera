...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        Point point0 = this;
        class SlopeCompare implements Comparator<Point> {
            public int compare(Point point1, Point point2) {
                if (point0.slopeTo(point1) == point0.slopeTo(point2)) return 0;
                if (point0.slopeTo(point1) < point0.slopeTo(point2)) return -1;
                return 1;
            }
        }
